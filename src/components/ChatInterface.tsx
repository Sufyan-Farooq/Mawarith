  ...
  return (
    ...
    >
      ...
      <div className="px-5 py-3.5 bg-obsidian-900 text-white border-b border-white/[0.08] flex items-center justify-between">
        ...
        <span className="text-xs font-semibold text-brass-400 bg-brass-400/10 px-2.5 py-1 rounded-full border border-brass-400/20">
          ...
          {messages.map((m) => (
            ...
            >
              ...
              >
                ...
                <span className={`block text-xs mt-2 opacity-60 ${m.sender === 'user' ? 'text-end' : ''}`}>
                  {m.timestamp}
                </span>
              </div>
            </motion.div>
